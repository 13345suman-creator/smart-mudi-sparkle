...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // Toast messages
  "toast_saved": { bn: "সংরক্ষিত হয়েছে ✅", hi: "सहेजा गया ✅", en: "Saved ✅" },
  "toast_deleted": { bn: "মুছে ফেলা হয়েছে", hi: "हटा दिया गया", en: "Deleted" },
  "toast_product_added": { bn: "পণ্য যোগ হয়েছে!", hi: "उत्पाद जोड़ा गया!", en: "Product added!" },
  "toast_product_updated": { bn: "পণ্য আপডেট হয়েছে!", hi: "उत्पाद अपडेट हुआ!", en: "Product updated!" },
  "toast_product_deleted": { bn: "পণ্য মুছে ফেলা হয়েছে!", hi: "उत्पाद हटाया गया!", en: "Product deleted!" },
  "toast_products_deleted": { bn: "টি পণ্য মুছে ফেলা হয়েছে!", hi: "उत्पाद हटाए गए!", en: "products deleted!" },
  "toast_duplicate_product": { bn: "এই নামে বা বারকোডে পণ্য আগে থেকেই আছে!", hi: "इस नाम या बारकोड से उत्पाद पहले से मौजूद है!", en: "Product with this name or barcode already exists!" },
  "toast_fill_required": { bn: "নাম, ক্রয়মূল্য, বিক্রয়মূল্য, স্টক ও একক আবশ্যক!", hi: "नाम, लागत, बिक्री मूल्य, स्टॉक और इकाई आवश्यक!", en: "Name, Cost Price, Sell Price, Stock & Unit are required!" },
  "toast_failed_add": { bn: "যোগ করতে ব্যর্থ", hi: "जोड़ने में विफल", en: "Failed to add" },
  "toast_failed_update": { bn: "আপডেট করতে ব্যর্থ", hi: "अपडेट करने में विफल", en: "Failed to update" },
  "toast_failed_delete": { bn: "মুছতে ব্যর্থ", hi: "हटाने में विफल", en: "Failed to delete" },
  "toast_copied": { bn: "ক্লিপবোর্ডে কপি হয়েছে!", hi: "क्लिपबोर्ड पर कॉपी हो गया!", en: "Copied to clipboard!" },
  "toast_share_failed": { bn: "শেয়ার সমর্থিত নয়", hi: "शेयर समर्थित नहीं", en: "Share not supported" },
  "toast_delete_success": { bn: "সফলভাবে মুছে ফেলা হয়েছে", hi: "सफलतापूर्वक हटाया गया", en: "deleted successfully" },
  "toast_enabled": { bn: "সক্রিয় করা হয়েছে ✅", hi: "सक्रिय किया गया ✅", en: "Enabled ✅" },
  "toast_disabled": { bn: "নিষ্ক্রিয় করা হয়েছে ❌", hi: "निष्क्रिय किया गया ❌", en: "Disabled ❌" },
  "toast_security_saved": { bn: "নিরাপত্তা সংরক্ষিত!", hi: "सुरक्षा सहेजी गई!", en: "Security saved!" },
  "toast_set_pin": { bn: "অনুগ্রহ করে ৪ সংখ্যার পিন সেট করুন", hi: "कृपया 4 अंकों का पिन सेट करें", en: "Please set a 4-digit PIN first" },
  "toast_backup_exported": { bn: "ব্যাকআপ এক্সপোর্ট হয়েছে!", hi: "बैकअप निर्यात हुआ!", en: "Backup exported!" },
  "toast_backup_restored": { bn: "ব্যাকআপ রিস্টোর হয়েছে! রিফ্রেশ হচ্ছে...", hi: "बैकअप बहाल हो गया! रिफ्रेश हो रहा...", en: "Backup restored! Refreshing..." },
  "toast_invalid_backup": { bn: "অবৈধ ব্যাকআপ ফাইল", hi: "अमान्य बैकअप फ़ाइल", en: "Invalid backup file" },
  "toast_no_auto_backup": { bn: "কোনো অটো ব্যাকআপ পাওয়া যায়নি", hi: "कोई ऑटो बैकअप नहीं मिला", en: "No auto backup found" },
  "toast_auto_backup_restored": { bn: "অটো ব্যাকআপ রিস্টোর হয়েছে! রিফ্রেশ হচ্ছে...", hi: "ऑटो बैकअप बहाल! रिफ्रेश हो रहा...", en: "Auto backup restored! Refreshing..." },
  "toast_auto_backup_corrupted": { bn: "অটো ব্যাকআপ নষ্ট হয়েছে", hi: "ऑटो बैकअप दूषित है", en: "Auto backup corrupted" },
  "toast_all_cleared": { bn: "সব ডাটা মুছে ফেলা হয়েছে! রিফ্রেশ হচ্ছে...", hi: "सब डेटा हटाया गया! रिफ्रेश हो रहा...", en: "All data cleared! Refreshing..." },
  "toast_email_no_match": { bn: "ইমেইল রেজিস্টার্ড অ্যাকাউন্টের সাথে মিলছে না", hi: "ईमेल पंजीकृत अकाउंट से मेल नहीं खाता", en: "Email doesn't match the registered account" },
  "toast_stock_deducted": { bn: "স্টক আপডেট হয়েছে", hi: "स्टॉक अपडेट हुआ", en: "Stock updated" },
